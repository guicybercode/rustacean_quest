...
impl Game {
    ...
    fn handle_coin_collection(&mut self, coin_x: f32, coin_y: f32) {
    ...
    fn handle_player_death_versus_p1(&mut self) {
        self.audio.play_death();
        if self.lives > 0 {
            self.lives -= 1;
        }
    ...
    fn handle_player_death_versus_p2(&mut self) {
        self.audio.play_death();
        if self.lives > 0 {
            self.lives -= 1;
        }
